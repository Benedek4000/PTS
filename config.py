...
numberOfIterations = 525600*12 #number of iterations
iterationTime = 5 #time interval between  in seconds
iterationPerSave = 1 #save after every x iteration
...
cellsOfInterest = [0, 810000, 1620000, 2430000, 3240000] #cells simulated, as a list of cell IDs