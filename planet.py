...
class Planet:
    ...
    def __init__(self, radius, orbitalRadius, starLuminosity, axialTilt, specificHeatCapacity, density, albedo, cellSize, initialTemperature):
    ...
    def calculateNextState(self, intervalBetweenStates, tqdmValue, fileToWrite):
